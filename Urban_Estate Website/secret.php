...
<head>
    ...
    <script type="text/javascript" src="newslet.js"></script>
    <title><?php
   echo $_SESSION['username']."'s Account - Urban Estate";
  ?></title>
</head>
<body>
  ...
  ?></a>
    ...
    <section class="home container" id="home">
        <div class="home-text">
            <h2 style="font-size:50px; color:#0277BD; ">
                <?php
   echo $_SESSION['username'].",";
   ?> 
   </h2>
            <h1 style="color:white; font-size:40px;">welcome to <br> Urban Estate
            </h1>            
        </div>
    </section>
    ...
    <section class="sales container" id="sales">
        <div class="box" id="b1"> 
            ...
            <h3>Step : 1</h3>
            <p>Login/Sign Up on Urban Estate</p>
        </div>
        ...
        <div class="box" id="b3">
            ...
            <h3>Step : 3</h3>
            <p>BUY or RENT your favourite home</p>
        </div>
    </section>
    ...
    <section class="properties container" id="properties">
        <div class="heading">
            ...
            <p>Explore a range of properties<br>at the best price </p>
        </div>
        <div class="properties-container container">
            ...
            <div class="box">
                ...
                <div class="content">
                    <div class="text">
                        <a href="property1.html">
                            <h3>The Queen's Palace</h3>
                        </a>
                        <p>New York</p>
                    </div>
                    <div class="icon">
                        <i class='bx bxs-bed'><span>4</span></i>
                        <i class='bx bxs-bath'><span>2</span></i>
                        <i class='bx bxs-parking'><span>3</span></i>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <div class="icon">
                        <i class='bx bxs-bed'><span>4</span></i>
                        <i class='bx bxs-bath'><span>2</span></i>
                        <i class='bx bxs-parking'><span>2</span></i>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <div class="icon">
                        <i class='bx bxs-bed'><span>4</span></i>
                        <i class='bx bxs-bath'><span>3</span></i>
                        <i class='bx bxs-parking'><span>4</span></i>
                    </div>
                </div>
            </div>
